...
AD_OBJ_CONTACT = core.ADObjectType(
    base_filter='(&(objectCategory=person)(objectClass=contact){})',
    ldap_class=['top', 'person', 'organizationalPerson', 'contact'],
    ldap_category='CN=Contact,CN=Schema,CN=Configuration,{}')
